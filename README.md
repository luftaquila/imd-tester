...
- **shell** — top panel + walls; holes for pot (Ø22.5 + anti-rotation notch), toggle (Ø6.2), 2 banana jacks (Ø8, 30 mm pitch), USB-C, display window (bezel + lip); captive-button pocket.
